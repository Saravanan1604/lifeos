...
const VOICE_LANGS = {
  ...
  // ---- Major world languages (core UI translated; rest falls back to English) ----
  es: { label: 'Español',   flag: '🇪🇸', speech: 'es-ES', tts: 'es-ES' },
  fr: { label: 'Français',  flag: '🇫🇷', speech: 'fr-FR', tts: 'fr-FR' },
  de: { label: 'Deutsch',   flag: '🇩🇪', speech: 'de-DE', tts: 'de-DE' },
  pt: { label: 'Português', flag: '🇧🇷', speech: 'pt-BR', tts: 'pt-BR' },
  ru: { label: 'Русский',   flag: '🇷🇺', speech: 'ru-RU', tts: 'ru-RU' },
  ar: { label: 'العربية',   flag: '🇸🇦', speech: 'ar-SA', tts: 'ar-SA' },
  zh: { label: '中文',       flag: '🇨🇳', speech: 'zh-CN', tts: 'zh-CN' },
  id: { label: 'Indonesia', flag: '🇮🇩', speech: 'id-ID', tts: 'id-ID' },
  bn: { label: 'বাংলা',     flag: '🇧🇩', speech: 'bn-BD', tts: 'bn-BD' },
  te: { label: 'తెలుగు',    flag: '🇮🇳', speech: 'te-IN', tts: 'te-IN' },
};
...
// ---- Major world languages — core UI strings -----------------
// Kept separate from I18N (which holds Tamil/Hindi) so adding languages
// doesn't require editing every existing entry. Each language maps the
// English source → translation; anything missing falls back to English.
const I18N_EXTRA = {
  es: {
    'Dashboard':'Panel','Finance':'Finanzas','All Assets':'Todos los activos','Budget':'Presupuesto','Bank Tracker':'Rastreador bancario','Habits':'Hábitos','Goals':'Metas','Journal':'Diario','Categories':'Categorías','Analytics':'Analíticas','Settings':'Ajustes','Sign Out':'Cerrar sesión','Records':'Registros','Assets':'Activos','More':'Más','Manage your atworth preferences':'Gestiona tus preferencias de atworth','Profile':'Perfil','Display Name':'Nombre visible','Currency Symbol':'Símbolo de moneda','Save Profile':'Guardar perfil','Theme':'Tema','Dark':'Oscuro','Light':'Claro','Auto':'Automático','Your Stats':'Tus estadísticas','Danger Zone':'Zona de peligro','Reset All Data':'Restablecer todos los datos','Day':'Día','Week':'Semana','Month':'Mes','Year':'Año','All':'Todo','Edit':'Editar','Save':'Guardar','Cancel':'Cancelar','Delete':'Eliminar','Search':'Buscar','Apply':'Aplicar','Income':'Ingresos','Expense':'Gastos','Net Worth':'Patrimonio neto','Savings':'Ahorros','Recent Transactions':'Transacciones recientes','Transactions':'Transacciones','This Month':'Este mes','Add Income':'Añadir ingreso','Add Expense':'Añadir gasto','AI Fix':'Arreglo IA','Merge':'Combinar','Asset Types':'Tipos de activos','Loan Types':'Tipos de préstamo','Add Category':'Añadir categoría','My Custom Categories':'Mis categorías personalizadas','Default Income Categories':'Categorías de ingresos predeterminadas','Default Expense Categories':'Categorías de gastos predeterminadas','Food':'Comida','Groceries':'Supermercado','Transport':'Transporte','Health':'Salud','Bills':'Facturas','Salary':'Salario','Business':'Negocio','Other':'Otro',
  },
  fr: {
    'Dashboard':'Tableau de bord','Finance':'Finances','All Assets':'Tous les actifs','Budget':'Budget','Bank Tracker':'Suivi bancaire','Habits':'Habitudes','Goals':'Objectifs','Journal':'Journal','Categories':'Catégories','Analytics':'Analytique','Settings':'Paramètres','Sign Out':'Déconnexion','Records':'Enregistrements','Assets':'Actifs','More':'Plus','Manage your atworth preferences':'Gérez vos préférences atworth','Profile':'Profil','Display Name':'Nom affiché','Currency Symbol':'Symbole monétaire','Save Profile':'Enregistrer le profil','Theme':'Thème','Dark':'Sombre','Light':'Clair','Auto':'Auto','Your Stats':'Vos statistiques','Danger Zone':'Zone de danger','Reset All Data':'Réinitialiser toutes les données','Day':'Jour','Week':'Semaine','Month':'Mois','Year':'Année','All':'Tout','Edit':'Modifier','Save':'Enregistrer','Cancel':'Annuler','Delete':'Supprimer','Search':'Rechercher','Apply':'Appliquer','Income':'Revenus','Expense':'Dépenses','Net Worth':'Valeur nette','Savings':'Épargne','Recent Transactions':'Transactions récentes','Transactions':'Transactions','This Month':'Ce mois-ci','Add Income':'Ajouter un revenu','Add Expense':'Ajouter une dépense','AI Fix':'Correction IA','Merge':'Fusionner','Asset Types':"Types d'actifs",'Loan Types':'Types de prêt','Add Category':'Ajouter une catégorie','My Custom Categories':'Mes catégories personnalisées','Default Income Categories':'Catégories de revenus par défaut','Default Expense Categories':'Catégories de dépenses par défaut','Food':'Nourriture','Groceries':'Épicerie','Transport':'Transport','Health':'Santé','Bills':'Factures','Salary':'Salaire','Business':'Entreprise','Other':'Autre',
  },
  de: {
    'Dashboard':'Übersicht','Finance':'Finanzen','All Assets':'Alle Vermögenswerte','Budget':'Budget','Bank Tracker':'Bank-Tracker','Habits':'Gewohnheiten','Goals':'Ziele','Journal':'Tagebuch','Categories':'Kategorien','Analytics':'Analysen','Settings':'Einstellungen','Sign Out':'Abmelden','Records':'Einträge','Assets':'Vermögen','More':'Mehr','Manage your atworth preferences':'Verwalte deine atworth-Einstellungen','Profile':'Profil','Display Name':'Anzeigename','Currency Symbol':'Währungssymbol','Save Profile':'Profil speichern','Theme':'Design','Dark':'Dunkel','Light':'Hell','Auto':'Auto','Your Stats':'Deine Statistiken','Danger Zone':'Gefahrenzone','Reset All Data':'Alle Daten zurücksetzen','Day':'Tag','Week':'Woche','Month':'Monat','Year':'Jahr','All':'Alle','Edit':'Bearbeiten','Save':'Speichern','Cancel':'Abbrechen','Delete':'Löschen','Search':'Suchen','Apply':'Anwenden','Income':'Einnahmen','Expense':'Ausgaben','Net Worth':'Nettovermögen','Savings':'Ersparnisse','Recent Transactions':'Letzte Transaktionen','Transactions':'Transaktionen','This Month':'Diesen Monat','Add Income':'Einnahme hinzufügen','Add Expense':'Ausgabe hinzufügen','AI Fix':'KI-Korrektur','Merge':'Zusammenführen','Asset Types':'Vermögensarten','Loan Types':'Kreditarten','Add Category':'Kategorie hinzufügen','My Custom Categories':'Meine eigenen Kategorien','Default Income Categories':'Standard-Einnahmekategorien','Default Expense Categories':'Standard-Ausgabekategorien','Food':'Essen','Groceries':'Lebensmittel','Transport':'Transport','Health':'Gesundheit','Bills':'Rechnungen','Salary':'Gehalt','Business':'Geschäft','Other':'Sonstiges',
  },
  pt: {
    'Dashboard':'Painel','Finance':'Finanças','All Assets':'Todos os ativos','Budget':'Orçamento','Bank Tracker':'Rastreador bancário','Habits':'Hábitos','Goals':'Metas','Journal':'Diário','Categories':'Categorias','Analytics':'Análises','Settings':'Configurações','Sign Out':'Sair','Records':'Registros','Assets':'Ativos','More':'Mais','Manage your atworth preferences':'Gerencie suas preferências do atworth','Profile':'Perfil','Display Name':'Nome de exibição','Currency Symbol':'Símbolo da moeda','Save Profile':'Salvar perfil','Theme':'Tema','Dark':'Escuro','Light':'Claro','Auto':'Automático','Your Stats':'Suas estatísticas','Danger Zone':'Zona de perigo','Reset All Data':'Redefinir todos os dados','Day':'Dia','Week':'Semana','Month':'Mês','Year':'Ano','All':'Tudo','Edit':'Editar','Save':'Salvar','Cancel':'Cancelar','Delete':'Excluir','Search':'Pesquisar','Apply':'Aplicar','Income':'Receita','Expense':'Despesa','Net Worth':'Patrimônio líquido','Savings':'Poupança','Recent Transactions':'Transações recentes','Transactions':'Transações','This Month':'Este mês','Add Income':'Adicionar receita','Add Expense':'Adicionar despesa','AI Fix':'Correção IA','Merge':'Mesclar','Asset Types':'Tipos de ativos','Loan Types':'Tipos de empréstimo','Add Category':'Adicionar categoria','My Custom Categories':'Minhas categorias personalizadas','Default Income Categories':'Categorias de receita padrão','Default Expense Categories':'Categorias de despesa padrão','Food':'Comida','Groceries':'Mercado','Transport':'Transporte','Health':'Saúde','Bills':'Contas','Salary':'Salário','Business':'Negócios','Other':'Outro',
  },
  ru: {
    'Dashboard':'Панель','Finance':'Финансы','All Assets':'Все активы','Budget':'Бюджет','Bank Tracker':'Банк-трекер','Habits':'Привычки','Goals':'Цели','Journal':'Дневник','Categories':'Категории','Analytics':'Аналитика','Settings':'Настройки','Sign Out':'Выйти','Records':'Записи','Assets':'Активы','More':'Ещё','Manage your atworth preferences':'Управляйте настройками atworth','Profile':'Профиль','Display Name':'Отображаемое имя','Currency Symbol':'Символ валюты','Save Profile':'Сохранить профиль','Theme':'Тема','Dark':'Тёмная','Light':'Светлая','Auto':'Авто','Your Stats':'Ваша статистика','Danger Zone':'Опасная зона','Reset All Data':'Сбросить все данные','Day':'День','Week':'Неделя','Month':'Месяц','Year':'Год','All':'Все','Edit':'Изменить','Save':'Сохранить','Cancel':'Отмена','Delete':'Удалить','Search':'Поиск','Apply':'Применить','Income':'Доход','Expense':'Расход','Net Worth':'Чистая стоимость','Savings':'Сбережения','Recent Transactions':'Последние операции','Transactions':'Операции','This Month':'Этот месяц','Add Income':'Добавить доход','Add Expense':'Добавить расход','AI Fix':'ИИ-исправление','Merge':'Объединить','Asset Types':'Типы активов','Loan Types':'Типы кредитов','Add Category':'Добавить категорию','My Custom Categories':'Мои категории','Default Income Categories':'Стандартные категории доходов','Default Expense Categories':'Стандартные категории расходов','Food':'Еда','Groceries':'Продукты','Transport':'Транспорт','Health':'Здоровье','Bills':'Счета','Salary':'Зарплата','Business':'Бизнес','Other':'Другое',
  },
  ar: {
    'Dashboard':'لوحة التحكم','Finance':'المالية','All Assets':'جميع الأصول','Budget':'الميزانية','Bank Tracker':'متتبع البنك','Habits':'العادات','Goals':'الأهداف','Journal':'اليوميات','Categories':'الفئات','Analytics':'التحليلات','Settings':'الإعدادات','Sign Out':'تسجيل الخروج','Records':'السجلات','Assets':'الأصول','More':'المزيد','Manage your atworth preferences':'إدارة تفضيلات atworth','Profile':'الملف الشخصي','Display Name':'اسم العرض','Currency Symbol':'رمز العملة','Save Profile':'حفظ الملف','Theme':'المظهر','Dark':'داكن','Light':'فاتح','Auto':'تلقائي','Your Stats':'إحصاءاتك','Danger Zone':'منطقة الخطر','Reset All Data':'إعادة تعيين كل البيانات','Day':'يوم','Week':'أسبوع','Month':'شهر','Year':'سنة','All':'الكل','Edit':'تعديل','Save':'حفظ','Cancel':'إلغاء','Delete':'حذف','Search':'بحث','Apply':'تطبيق','Income':'الدخل','Expense':'المصروفات','Net Worth':'صافي الثروة','Savings':'المدخرات','Recent Transactions':'المعاملات الأخيرة','Transactions':'المعاملات','This Month':'هذا الشهر','Add Income':'إضافة دخل','Add Expense':'إضافة مصروف','AI Fix':'إصلاح بالذكاء الاصطناعي','Merge':'دمج','Asset Types':'أنواع الأصول','Loan Types':'أنواع القروض','Add Category':'إضافة فئة','My Custom Categories':'فئاتي المخصصة','Default Income Categories':'فئات الدخل الافتراضية','Default Expense Categories':'فئات المصروفات الافتراضية','Food':'طعام','Groceries':'بقالة','Transport':'نقل','Health':'صحة','Bills':'فواتير','Salary':'راتب','Business':'أعمال','Other':'أخرى',
  },
  zh: {
    'Dashboard':'仪表板','Finance':'财务','All Assets':'所有资产','Budget':'预算','Bank Tracker':'银行追踪','Habits':'习惯','Goals':'目标','Journal':'日记','Categories':'类别','Analytics':'分析','Settings':'设置','Sign Out':'退出登录','Records':'记录','Assets':'资产','More':'更多','Manage your atworth preferences':'管理你的 atworth 偏好设置','Profile':'个人资料','Display Name':'显示名称','Currency Symbol':'货币符号','Save Profile':'保存资料','Theme':'主题','Dark':'深色','Light':'浅色','Auto':'自动','Your Stats':'你的统计','Danger Zone':'危险区域','Reset All Data':'重置所有数据','Day':'日','Week':'周','Month':'月','Year':'年','All':'全部','Edit':'编辑','Save':'保存','Cancel':'取消','Delete':'删除','Search':'搜索','Apply':'应用','Income':'收入','Expense':'支出','Net Worth':'净资产','Savings':'储蓄','Recent Transactions':'最近交易','Transactions':'交易','This Month':'本月','Add Income':'添加收入','Add Expense':'添加支出','AI Fix':'AI 修正','Merge':'合并','Asset Types':'资产类型','Loan Types':'贷款类型','Add Category':'添加类别','My Custom Categories':'我的自定义类别','Default Income Categories':'默认收入类别','Default Expense Categories':'默认支出类别','Food':'餐饮','Groceries':'杂货','Transport':'交通','Health':'健康','Bills':'账单','Salary':'工资','Business':'商业','Other':'其他',
  },
  id: {
    'Dashboard':'Dasbor','Finance':'Keuangan','All Assets':'Semua Aset','Budget':'Anggaran','Bank Tracker':'Pelacak Bank','Habits':'Kebiasaan','Goals':'Tujuan','Journal':'Jurnal','Categories':'Kategori','Analytics':'Analitik','Settings':'Pengaturan','Sign Out':'Keluar','Records':'Catatan','Assets':'Aset','More':'Lainnya','Manage your atworth preferences':'Kelola preferensi atworth Anda','Profile':'Profil','Display Name':'Nama Tampilan','Currency Symbol':'Simbol Mata Uang','Save Profile':'Simpan Profil','Theme':'Tema','Dark':'Gelap','Light':'Terang','Auto':'Otomatis','Your Stats':'Statistik Anda','Danger Zone':'Zona Bahaya','Reset All Data':'Atur Ulang Semua Data','Day':'Hari','Week':'Minggu','Month':'Bulan','Year':'Tahun','All':'Semua','Edit':'Edit','Save':'Simpan','Cancel':'Batal','Delete':'Hapus','Search':'Cari','Apply':'Terapkan','Income':'Pemasukan','Expense':'Pengeluaran','Net Worth':'Kekayaan Bersih','Savings':'Tabungan','Recent Transactions':'Transaksi Terbaru','Transactions':'Transaksi','This Month':'Bulan Ini','Add Income':'Tambah Pemasukan','Add Expense':'Tambah Pengeluaran','AI Fix':'Perbaikan AI','Merge':'Gabungkan','Asset Types':'Jenis Aset','Loan Types':'Jenis Pinjaman','Add Category':'Tambah Kategori','My Custom Categories':'Kategori Khusus Saya','Default Income Categories':'Kategori Pemasukan Default','Default Expense Categories':'Kategori Pengeluaran Default','Food':'Makanan','Groceries':'Belanjaan','Transport':'Transportasi','Health':'Kesehatan','Bills':'Tagihan','Salary':'Gaji','Business':'Bisnis','Other':'Lainnya',
  },
  bn: {
    'Dashboard':'ড্যাশবোর্ড','Finance':'অর্থ','All Assets':'সমস্ত সম্পদ','Budget':'বাজেট','Bank Tracker':'ব্যাংক ট্র্যাকার','Habits':'অভ্যাস','Goals':'লক্ষ্য','Journal':'জার্নাল','Categories':'বিভাগ','Analytics':'বিশ্লেষণ','Settings':'সেটিংস','Sign Out':'সাইন আউট','Records':'রেকর্ড','Assets':'সম্পদ','More':'আরও','Manage your atworth preferences':'আপনার atworth পছন্দ পরিচালনা করুন','Profile':'প্রোফাইল','Display Name':'প্রদর্শন নাম','Currency Symbol':'মুদ্রার প্রতীক','Save Profile':'প্রোফাইল সংরক্ষণ','Theme':'থিম','Dark':'ডার্ক','Light':'লাইট','Auto':'স্বয়ংক্রিয়','Your Stats':'আপনার পরিসংখ্যান','Danger Zone':'বিপদ অঞ্চল','Reset All Data':'সমস্ত ডেটা রিসেট করুন','Day':'দিন','Week':'সপ্তাহ','Month':'মাস','Year':'বছর','All':'সব','Edit':'সম্পাদনা','Save':'সংরক্ষণ','Cancel':'বাতিল','Delete':'মুছুন','Search':'খুঁজুন','Apply':'প্রয়োগ','Income':'আয়','Expense':'ব্যয়','Net Worth':'নিট সম্পদ','Savings':'সঞ্চয়','Recent Transactions':'সাম্প্রতিক লেনদেন','Transactions':'লেনদেন','This Month':'এই মাস','Add Income':'আয় যোগ করুন','Add Expense':'ব্যয় যোগ করুন','AI Fix':'AI ঠিক','Merge':'একত্র করুন','Asset Types':'সম্পদের ধরন','Loan Types':'ঋণের ধরন','Add Category':'বিভাগ যোগ করুন','My Custom Categories':'আমার কাস্টম বিভাগ','Default Income Categories':'ডিফল্ট আয় বিভাগ','Default Expense Categories':'ডিফল্ট ব্যয় বিভাগ','Food':'খাবার','Groceries':'মুদিখানা','Transport':'পরিবহন','Health':'স্বাস্থ্য','Bills':'বিল','Salary':'বেতন','Business':'ব্যবসা','Other':'অন্যান্য',
  },
  te: {
    'Dashboard':'డాష్‌బోర్డ్','Finance':'ఆర్థికం','All Assets':'అన్ని ఆస్తులు','Budget':'బడ్జెట్','Bank Tracker':'బ్యాంక్ ట్రాకర్','Habits':'అలవాట్లు','Goals':'లక్ష్యాలు','Journal':'జర్నల్','Categories':'విభాగాలు','Analytics':'విశ్లేషణ','Settings':'సెట్టింగ్‌లు','Sign Out':'సైన్ అవుట్','Records':'రికార్డులు','Assets':'ఆస్తులు','More':'మరిన్ని','Manage your atworth preferences':'మీ atworth ప్రాధాన్యతలను నిర్వహించండి','Profile':'ప్రొఫైల్','Display Name':'ప్రదర్శన పేరు','Currency Symbol':'కరెన్సీ చిహ్నం','Save Profile':'ప్రొఫైల్ సేవ్ చేయి','Theme':'థీమ్','Dark':'డార్క్','Light':'లైట్','Auto':'ఆటో','Your Stats':'మీ గణాంకాలు','Danger Zone':'ప్రమాద ప్రాంతం','Reset All Data':'మొత్తం డేటా రీసెట్ చేయి','Day':'రోజు','Week':'వారం','Month':'నెల','Year':'సంవత్సరం','All':'అన్ని','Edit':'సవరించు','Save':'సేవ్','Cancel':'రద్దు','Delete':'తొలగించు','Search':'వెతుకు','Apply':'వర్తించు','Income':'ఆదాయం','Expense':'ఖర్చు','Net Worth':'నికర విలువ','Savings':'పొదుపు','Recent Transactions':'ఇటీవలి లావాదేవీలు','Transactions':'లావాదేవీలు','This Month':'ఈ నెల','Add Income':'ఆదాయం జోడించు','Add Expense':'ఖర్చు జోడించు','AI Fix':'AI సరిచేయి','Merge':'విలీనం','Asset Types':'ఆస్తి రకాలు','Loan Types':'రుణ రకాలు','Add Category':'విభాగం జోడించు','My Custom Categories':'నా అనుకూల విభాగాలు','Default Income Categories':'డిఫాల్ట్ ఆదాయ విభాగాలు','Default Expense Categories':'డిఫాల్ట్ ఖర్చు విభాగాలు','Food':'ఆహారం','Groceries':'కిరాణా','Transport':'రవాణా','Health':'ఆరోగ్యం','Bills':'బిల్లులు','Salary':'జీతం','Business':'వ్యాపారం','Other':'ఇతర',
  },
};
...
function t(en) {
  ...
  const entry = I18N[en];
  if (entry && entry[lang]) return entry[lang];                 // Tamil / Hindi
  if (I18N_EXTRA[lang] && I18N_EXTRA[lang][en]) return I18N_EXTRA[lang][en]; // major languages
...
function _buildReverse() {
  ...
  // Major-language translations → English source (so we can revert from them)
  for (const lang in I18N_EXTRA) {
    const map = I18N_EXTRA[lang];
    for (const en in map) {
      _REVERSE[en.toLowerCase()] = en;
      if (map[en]) _REVERSE[map[en].toLowerCase()] = en;
    }
  }
}
